              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-white text-white-200 text-xl">
                    It Is A platform designed to give visitors the amenities
                    that they need by providing them with several types of
                    entertainment such as luxury villas that have swimming
                    pools, Barbecue areas, and wide yards .
                  </p>
                  <p className="mt-4 text-white text-white-200 text-xl">
                    So Be A Part Of Our Family And Give Your Vacation What it
                    Deserves
                  </p>
                </div>
              </div>
